...
function User(username, email, isActive) {
  ...
  function theDestinations(maxDistance, maxBudget) {
    let result = [];
    

    destinations.forEach(destination => {
      if (destination.distance <= maxDistance && destination.budgetRequired <= maxBudget) {
  ...
  console.log(theDestinations(400, 450));
